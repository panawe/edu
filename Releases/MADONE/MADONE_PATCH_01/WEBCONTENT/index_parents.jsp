...
<f:view locale="#{userBean.selectedLocale}">
	...
	<ul>
		...
		<li class="active"><a href="index_parents.faces"><span>PARENTS</span></a></li>
	...
	<div class="mainbar">
	<div class="article">
	<h2><span>Meilleur</span> Suivi de l'Education de vos Enfants</h2>
	<div class="clr"></div>
	<div class="img"><img src="images/img2.jpg" width="236"
		height="245" alt="" class="fl" /></div>
	<div class="post_content">
	<p>Le <strong>dossier complet de votre enfant est
	disponible en ligne</strong> et consultable par vous-meme que par vos enfants
	eux-memes. Ce dossier inclu les notes et moyennes, les informations
	disciplinaires telles que les retards, absenses ou punitions, les
	recompenses et reconnaissances, l'emploi du temps, les examptions et
	informations medicales, pour ne citer que ceux-la.
	...
	<div class="clr"></div>
	<ul class="ex_menu">
		<li><a href="index_inscription.faces">Inscrire mon enfant en
		ligne</a><br />
