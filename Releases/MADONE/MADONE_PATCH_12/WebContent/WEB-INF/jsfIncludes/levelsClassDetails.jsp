			...
			<tr>
				...
				<td><rich:comboBox id="schoolYear"
					...
					<td><h:selectOneMenu id="outcomeSearchCriateria"
							value="#{levelClassBean.decision}"
							binding="#{levelClassBean.mySecondValue}">
							<f:selectItem itemLabel="" itemValue="" />
							<f:selectItems value="#{levelClassBean.configsByGroupName}" />
					...
					<tr>
						<a4j:region>
							...
							<td><rich:comboBox id="schoolYear"
									...
									suggestionValues="#{schoolYearBean.allSchoolYears}">
									<a4j:support event="onchange" ajaxSingle="true"
										action="#{levelClassBean.findTuitions}"
										reRender="tuitionShutle" />
								</rich:comboBox></td>
						</a4j:region>
					</tr>
