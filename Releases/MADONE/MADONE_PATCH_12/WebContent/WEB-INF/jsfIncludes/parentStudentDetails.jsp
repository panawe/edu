		...
		<table>
			<tr>
				...
				<td><a4j:commandButton value="#{msg.search}" id="searchButtom"
						...
						oncomplete="if (#{levelClassBean.searchRowCount <= 0}) #{rich:component('resultPanelParentStudent')}.show();" />
				</td>
									...
									<td colspan="2"><rich:listShuttle id="studentShutle"
											...
											<rich:column width="100">
												...
												<h:selectOneMenu 
													...
													binding="#{parentBean.myThirdValue}">
													<f:selectItems value="#{parentBean.thirdConfigsByGroupName}" />
...
<rich:modalPanel id="resultPanelParentStudent" autosized="true" width="300">
	<f:facet name="header">
		<h:outputText value="#{msg.result}" />
	</f:facet>
	<a4j:form>
		...
		<p>
			<a4j:commandButton value="Fermer"
				...
				oncomplete=" #{rich:component('resultPanelParentStudent')}.hide();" />
		</p>
	</a4j:form>
</rich:modalPanel>
