			...
			<rich:dataTable
				...
				<rich:column width="90">
					...
					<a4j:commandLink ajaxSingle="true" id="selectProduit"
						...
						reRender="demandeProductPannel1"
						oncomplete="#{rich:component('demandeProductPannel1')}.show()">
...
<rich:modalPanel id="demandeProductPannel1" autosized="true" width="300">
	<f:facet name="header">
		<h:outputText value="#{msg.demand}" />
	</f:facet>
	<f:facet name="controls">
		<h:panelGroup>
			<h:graphicImage value="/images/close.png" id="hidelink4"
				styleClass="hidelink" />
			<rich:componentControl for="demandeProductPannel1" attachTo="hidelink4"
	...
	<a4j:form>
		<h:panelGrid columns="2">
			...
			<a4j:commandButton value="#{msg.save}" action="#{productBean.demandForTeacher}"
				reRender="productConsumers"
				oncomplete="if (#{facesContext.maximumSeverity==null}) #{rich:component('demandeProductPannel1')}.hide();" />
		</h:panelGrid>
	</a4j:form>
</rich:modalPanel>
