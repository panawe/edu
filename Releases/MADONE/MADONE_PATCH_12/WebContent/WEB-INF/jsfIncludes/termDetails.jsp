		...
		<rich:panel style="overflow: hidden; width: 75%; white-space: nowrap;">
			...
			<table class="table">
				<tr>
					...
					<td>
						<h:inputText id="tdescription" value="#{termBean.term.description}" size="30" maxlength="100" onchange="convertToUpperCase(this);">
							<rich:ajaxValidator event="onblur" />
						</h:inputText> 
						<font color="#FF0000"><rich:message for="tdescription" /></font>
					</td>
				</tr>
