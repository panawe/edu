		...
		<a4j:outputPanel id="users">
			<rich:dataTable rows="5" value="#{userBean.activeUsers}" var="user"
			    ...
			    <rich:column>
			        ...
			        <a4j:commandLink ajaxSingle="true" id="chooseWeekEndingSearchUser" 
			        action="#{userProjectBean.assignUserForSearching}" 
			        rendered="#{pageProvenence == 'WEEK_ENDING_SUMMARY'}" 
			        reRender="resourceWeekEndingSearchCriteria"
					oncomplete="#{rich:component('resourceWeekEndingPanelUers')}.hide()">
			            <h:graphicImage value="images/addtobasket.gif" style="border:0"/>
			            <f:param name="id" value="#{user.id}"/>
			        </a4j:commandLink>  
			       
			        <a4j:commandLink ajaxSingle="true" id="chooseProjectUser" 
			        action="#{userProjectBean.assignUserToProject}" 
			        rendered="#{pageProvenence == 'USER_PROJECT'}" 
			        reRender="projectUserOutputPanel"
					oncomplete="#{rich:component('resultPanelUers')}.hide()">
			            <h:graphicImage value="images/addtobasket.gif" style="border:0"/>
			            <f:param name="id" value="#{user.id}"/>
			        </a4j:commandLink>  
			        ...
			        rendered="#{link != 'security' && link != 'consultation' && pageProvenence != 'USER_PROJECT'}" 
