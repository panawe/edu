...
<f:view locale="#{userBean.selectedLocale}">
	...
	<a4j:form>
		<ul>
			...
			<h3><h:outputText value="#{newsBean.news1.author}" />-  <h:outputText value="#{newsBean.news1.newsDate}">
			...
			<h3><h:outputText value="#{newsBean.news2.author}" />- <h:outputText value="#{newsBean.news2.newsDate}">
				<f:convertDateTime pattern="dd/MM/yyyy" />
			</h:outputText></h3>
			</p>
			</div>
