		...
		<h:panelGrid columns="2">
			...
			<a4j:outputPanel ajaxRendered="true">
				...
				<h:panelGrid columns="2">
					...
					<h:outputText value="#{paymentBean.tuition.amount-paymentBean.tuition.paid}" />
					...
					<a4j:commandButton value="#{msg.save}"
						...
						<font color="#FF0000"> <error> <h:outputText value="#{examBean.errorMessage}" /> </error> </font>
				</h:panelGrid>
			</a4j:outputPanel>
		</h:panelGrid>
...
<rich:modalPanel id="printPaymentReceipt" autosized="true" width="300">
	...
	<a4j:form>
		<p><h:commandButton id="view" value="#{msg.viewPdf }"
			action="#{paymentBean.printReceipt}" /></p>
		<p></p>
		<p><a4j:commandButton value="#{msg.close }"
			oncomplete="#{rich:component('printPaymentReceipt')}.hide();" /></p>
	</a4j:form>
</rich:modalPanel>
