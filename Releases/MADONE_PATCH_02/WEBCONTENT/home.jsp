...
<f:view locale="#{userBean.selectedLocale}">
	...
	<tr>
		<td align="center" valign="top"><a4j:region>

			<h:form>

				<a4j:poll id="poll" interval="60000"
					action="#{userBean.getNewItems}" enabled="true"
					reRender="myTests,myMarks, myDemands, myNews" />
			</h:form>
			...
			<tr>
					...
					<tr>
						<td valign="top"><a4j:form>
							<a4j:region>
								...
								<rich:panel bodyClass="pbody" id="myTests" style="width: 300px;">
									<f:facet name="header">
									...
									<h:panelGrid columns="2" style="font-size : smaller;"
										...
										<h:outputText value="#{userBean.userTest.test.subject.name}" />
					...
					<tr>
						<td align="justify" valign="bottom"><a4j:form>
							<a4j:region>
								...
								<rich:panel bodyClass="pbody" id="myMarks" style="width: 300px;">
									<f:facet name="header">
				...
				<table height="350"  >
							...
							<a4j:region>
								...
								<rich:panel bodyClass="pbody" id="myDemands"
									...
									<h:panelGrid columns="2" style="font-size : smaller;"
										...
										<h:outputText value="#{userBean.demand.possibleReturnedDate}">
											<f:convertDateTime pattern="#{configurationBean.dateFormat}" />
										</h:outputText>
										...
										<h:outputText escape="true" value="#{userBean.demand.comment}" />
					...
					<tr>
						...
						<td align="justify" valign="bottom"><a4j:form>
							<a4j:region>
								<rich:panel bodyClass="pbody" id="myNews" style="width: 300px;">
									<f:facet name="header">
									...
									<h:panelGrid columns="2" style="font-size : smaller;"
										...
										<h:outputText value="#{msg.description }" styleClass="label"></h:outputText>
										<h:outputText value="#{userBean.news.message}" escape="false" />
		...
		<rich:modalPanel id="testPanel" resizeable="true" height="600"
			autosized="false" width="800">
			<f:facet name="header">
				<h:outputText
					value="#{msg.testInProgress} | #{userBean.currentTest.title }" />
			</f:facet>
			<div style="width: 100%; height: 100%; overflow: auto;"><a4j:outputPanel
				id="renderMe">
				...
				<a4j:form>
					<a4j:region>
						...
						<rich:panel header="#{msg.question} #{userBean.questionHeader}"
							rendered="#{userBean.currentSequence>0 and userBean.currentSequence<= userBean.nbrQuestions  }">
							<h:outputText value="#{userBean.currentQuestion.question.body }"
								escape="false"
								rendered="#{userBean.currentSequence>0 and userBean.currentSequence<= userBean.nbrQuestions  }" />
						...
						<rich:dataTable rows="100" value="#{userBean.currentAnswers}"
							...
							<rich:column width="60">
								...
								<h:selectBooleanCheckbox id="checked" value="#{answer.checked}">
									<a4j:support action="#{userBean.changeAnswer}" event="onclick"
										immediate="true" id="ChangeAnswer">
			...
			<a4j:form>
				<p><h:commandButton id="viewss" value="#{msg.viewPdf }"
					action="#{userBean.showUserTestDetails}" /></p>
				<p></p>
				<p><a4j:commandButton value="#{msg.close }"
					oncomplete="#{rich:component('printTestResults')}.hide();" /></p>
			</a4j:form>
		</rich:modalPanel></td>
	</tr>
