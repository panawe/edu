...
<a4j:form>
	<a4j:commandButton ajaxSingle="true" id="importExamMark2"
		...
		<a4j:outputPanel id="exams">
			<rich:dataTable rows="15" value="#{examBean.exams}" var="exam"
				...
				<rich:column width="160">
					...
					<rich:spacer width="20" height="10" title="" />
					<a4j:commandLink  id="importExamMark"
						action="#{examBean.edit}"  oncomplete="#{rich:component('examMarkImportPanel')}.show();">
