		...
		<table width="100%">
			<tr>
				...
				<tr>
					...
					<td>
						<a4j:commandButton ajaxSingle="true" id="importStudentsFromFile"
							onclick="#{rich:component('studentImportFilePanel')}.show()"
							rendered="#{studentBean.userHasWriteAccess}"
							reRender="importStudentFileInfo" value="#{msg.importStudents}"
							oncomplete="#{rich:component('studentImportFilePanel')}.show();">
						</a4j:commandButton>
					</td>
					<td>
...
<rich:modalPanel id="studentImportFilePanel" rendered="true" height="240">
	<a4j:form>
	<f:facet name="header">
	...
	<table>
		<a4j:region>
			<tr>
				...
				disabled="false"
					fileUploadListener="#{studentBean.uploadStudentData}"
					maxFilesQuantity="5" id="uploadStudentData" listWidth="250"
					listHeight="70" immediateUpload="#{examBean.autoUpload}"
					addControlLabel="#{msg.importStudents}"
					...
					<a4j:support event="onuploadcomplete" reRender="importStudentFileInfo" />
					<f:facet name="label">
			...
			<h:panelGroup id="importStudentFileInfo">
	               <f:facet name="header">
					<h:outputText value="#{msg.result}" />
				</f:facet>
				<a4j:form>
					<p>
						<h:inputTextarea id="errors" style="#{ empty studentBean.errorMessage ? 'border-color:black;' : 'border-color:red;'}"
							value="#{studentBean.errorMessage}" rows="3" cols="50">
						</h:inputTextarea>
					</p>
			
					<p><a4j:commandButton value="#{msg.close }" immediate="true"
						action="#{studentBean.clearMessages}"
						oncomplete="#{rich:component('studentImportFilePanel')}.hide();" /></p>
				</a4j:form>
		    </h:panelGroup>
</rich:modalPanel>
