...
<f:view locale="#{userBean.selectedLocale}">
	...
	<tr valign="top">
		<td valign="top">
			...
			<rich:tabPanel switchType="ajax" width="100%" id="projectSummaryPanel"
				selectedTab="#{userProjectBean.selectedTab}" immediate="true">
				<rich:tab id="projectSummaryList" label="#{msg.research}" status="status">
					<%@include file="/WEB-INF/jsfIncludes/iproject/clientProjectSummaryList.jsp"%>
				</rich:tab>
			</rich:tabPanel>
		</td>
	</tr>
