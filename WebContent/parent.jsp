...
<f:view locale="#{userBean.selectedLocale}">
	...
	<tr valign="top">
		<td valign="top"><rich:simpleTogglePanel switchType="ajax"
			...
			<rich:tab id="parentPaymentList" label="#{msg.payment}">
				<a4j:support event="ontabenter" ajaxSingle="true"
					action="#{parentBean.resetPayments}">
				</a4j:support>
				<f:attribute name="tabName" value="PARENT_PAYMENT_LIST" />
				<%@include file="/WEB-INF/jsfIncludes/parentPaymentList.jsp"%>
			</rich:tab>
