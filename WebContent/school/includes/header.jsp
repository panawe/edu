...
<link rel="stylesheet" href="school/styles/layout.css" type="text/css" />
<!-- Homepage Specific Elements -->
<script type="text/javascript" src="school/scripts/jquery-1.4.1.min.js"></script>
<script type="text/javascript" src="school/scripts/jquery-ui-1.7.2.custom.min.js"></script>
<script type="text/javascript" src="school/scripts/jquery.tabs.setup.js"></script>
    ...
    <div class="fl_right">
      ...
      <form action="#" method="post" id="sitesearch">
        <fieldset>
          ...
          <input type="image" src="school/images/search.gif" id="search" alt="Search" />
        </fieldset>
      </form>
    </div>
  </div>
