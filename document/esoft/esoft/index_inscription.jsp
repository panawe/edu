...
<f:view locale="#{userBean.selectedLocale}">
	...
	<div class="fullmainbar"><a4j:form>
		<a4j:region>
			...
			<rich:tabPanel switchType="ajax" width="100%" id="tempStudentPanel"
				immediate="true">
				<rich:tab id="decision" label="#{msg.decision }"
					rendered="#{!empty studentBean.student.matricule }">
					<strong> <br />
				...
				<rich:tab id="files" label="#{msg.demandeInscription}">
					<table width="100%" border="0">
						...
						<tr>
							<td valign="top"><a4j:commandButton onclick="buttonClicked = true; "
								value="#{msg.saveSendDemand}" action="#{studentBean.insert}"
			...
			<a4j:status onstart="if (buttonClicked) {#{rich:component('wait')}.show()}"
