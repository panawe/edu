...
<script type="text/javascript" src="jeantabi/scripts/jquery-1.4.1.min.js"></script>
<script type="text/javascript" src="jeantabi/scripts/jquery-ui-1.7.2.custom.min.js"></script>
<script type="text/javascript" src="jeantabi/scripts/jquery.tabs.setup.js"></script>
  ...
  <div id="header" class="clear">
    ...
    <div class="fl_right">
      <ul>
        ...
        <li class="last"><a href="index.faces#bottom">Connexion</a></li>
      </ul>
