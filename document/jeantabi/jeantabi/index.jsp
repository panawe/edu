...
<f:view locale="#{userBean.selectedLocale}">
	...
	<div class="featured_box" id="fc1"><img src="jeantabi/images/1.jpg"
		alt="" />
	<div class="floater">
	<h2>Ecole moderne</h2>
	...
	<div class="featured_box" id="fc2"><img src="jeantabi/images/2.jpg"
		alt="" />
	<div class="floater">
	...
	<div class="featured_box" id="fc3"><img src="jeantabi/images/3.jpg"
		alt="" />
	<div class="floater">
	...
	<div class="featured_box" id="fc4"><img src="jeantabi/images/4.jpg"
		alt="" />
	<div class="floater">
	...
	<div class="featured_box" id="fc5"><img src="jeantabi/images/5.jpg"
		alt="" />
	<div class="floater">
	...
	<ul id="featured_tabs">
		<li><a href="#fc1">A Propos du College Jean Tabi</a></li>
		<li><a href="#fc2">Pourquoi Choisir le College Jean Tabi</a></li>
	...
	<div id="left_column">
	<h2>Futurs Eleves</h2>
	<div class="imgholder"><a href="index_jt_inscription.faces"><img
		src="jeantabi/images/register_online.jpg" alt="" /></a></div>
	...
	<ul>
		...
		<p> 
		<h3><a href="index_jt_topnews.faces"><h:outputText value="#{newsBean.news1.title}"/></a></h3>
		 </p>
		...
		<div class="latestnews">
		<p>
		<h3><a href="index_jt_topnews.faces"><h:outputText value="#{newsBean.news2.title}"/></a></h3>
	...
	<p class="readmore"><a href="index_jt_news.faces">Cliquez
	...
	<div class="apply"><a href="#"><img
		src="jeantabi/images/tour.jpg" alt="" /> <strong>Visite
