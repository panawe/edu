...
<f:view locale="#{userBean.selectedLocale}">
	...
	<div id="left_column">
	<h2>Futurs Eleves</h2>
	<div class="imgholder"><a href="index_school_inscription.faces"><img
	...
	<ul>
		...
		<p> 
		<h3><a href="index_school_topnews.faces"><h:outputText value="#{newsBean.news1.title}"/></a></h3>
		 </p>
		...
		<div class="latestnews">
		<p>
		<h3><a href="index_school_topnews.faces"><h:outputText value="#{newsBean.news2.title}"/></a></h3>
	...
	<p class="readmore"><a href="index_school_news.faces">Cliquez
