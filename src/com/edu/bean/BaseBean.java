...
public class BaseBean implements Constants {
	...
	public ResourceBundle getResourceBundle() {
		if (resourceBundle == null)
			resourceBundle  = ResourceBundle.getBundle("/com.edu.config.MessageRessources", getContext().getViewRoot().getLocale());
	...
	public void setResourceBundle(Locale locale) {
		if (resourceBundle == null)
			resourceBundle  = ResourceBundle.getBundle("/com.edu.config.MessageRessources", locale);
	}
