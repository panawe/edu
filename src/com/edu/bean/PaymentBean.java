...
public class PaymentBean extends BaseBean {
	...
	public String  prePrintReminder(){
		...
		relance.setMessage("A défaut de payement à la date limite ci-dessus, votre enfant ne sera plus accepté en classe.\n"+
"La comptabilité est ouverte tous les jours du lundi au vendredi de 7h à 11h 30 et de 15h à 17h. "+
"Le règlement peut être effectué "+
"en espèces CFA ou par chèque CFA libellé à l’ordre de «"+student.getSchool().getName()+" ».\n");
