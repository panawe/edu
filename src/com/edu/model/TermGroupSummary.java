...
@Table(name="TERM_GROUP_SUMMARY")
@Entity
public class TermGroupSummary extends BaseEntity implements Comparable<TermGroupSummary>{
	@Id
	...
	public int compareTo(TermGroupSummary other) {
		// TODO Auto-generated method stub
		if(other !=null ){
